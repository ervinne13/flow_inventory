    ...
    <jsp:body>
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form:form id="partnerForm" method="PUT" action="/partners/${partner.id}" modelAttribute="partner">
                            <div class="box box-info">
                                <div class="box-header with-border">
                                    <h3 class="box-title">
                                        <i class="fa fa-group"></i> <span>Partner Details</span>
                                    </h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                            ...
                            <button id="update-partner" type="button" class="pull-right btn btn-success">Save</button>
